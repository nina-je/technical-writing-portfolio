...
- `docs/api/` – sample API documentation  
- `docs/guides/` – user-oriented how-to guides  
- `docs/reference/` – reference materials, data models, and system parameters

>Note: Samples are illustrative and not tied to a live production system.
